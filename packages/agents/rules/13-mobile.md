...
description: Expo patterns # Required for agent_requested
---

_EVERY_ Expo app must adhere to policy unless explicitly prohibited in comment before the action or workflow definition.
